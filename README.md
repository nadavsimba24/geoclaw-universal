...
```bash
# Install globally like OpenClaw (all platforms)
npm install -g "https://github.com/nadavsimba24/geoclaw-universal.git"

# Alternative methods:
# Linux/macOS/WSL: curl -fsSL https://raw.githubusercontent.com/nadavsimba24/geoclaw-universal/main/install.sh | bash
# Windows PowerShell: Run install-windows.ps1
```
...
### **Alternative: Create Project Instance**
```bash
# Create a new project (like openclaw init)
geoclaw init --name my-agent

# Enter project and setup
cd my-agent
geoclaw setup
geoclaw start
```
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/nadavsimba24/geoclaw-universal/issues)
